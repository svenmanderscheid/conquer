...
try{
 ...
 T::applyPreset(1,2);T::equipTreasure(1,60100002,1,25);T::savePreset(1,3);$rate=BuildingData::getHourlyRate('lumber_camp',5,\Conquer\Game\Vip\VipService::status(1)['bonuses']);$bonus=BuffEngine::getBuffs(1,1)['lumber_production'];
