...
window.ConquerTraining=function(ctx){
    ...
    function render(){
        ...
        const portraitArt=school.type===1
            ?`characters/infantry-t${tier}-ui-v${tier===10?2:1}`
            :`characters/${school.type===2?'archer':'cavalry'}-t${tier}-ui-v1`;
        ...
        if(school.type===1){const topTier=root().querySelector('.training-tier[data-tier="10"] img');if(topTier)topTier.src=base+'/assets/art/characters/infantry-t10-thumb-v2.webp';}
